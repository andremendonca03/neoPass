...
const ForgotPassword = () => {
  ...
  function handleChange() {
    ...
    const fieldsConfirm = Array.from(
      document.getElementsByName("confirmpassword")
    );
  ...
  return (
    <button
      type="button"
      tabIndex="-1"
      className={styles.viewHidePasswordBtn}
      onClick={handleChange}
    >
      {formCtx.isPasswordVisible ? (
        <global.Image
          src="/hide-password-icon.svg"
          alt="Hide Password"
          width={19}
          height={18}
